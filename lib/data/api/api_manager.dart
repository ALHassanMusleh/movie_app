...
abstract class ApiManager {
  ...
  static Future<PopularResponse> getPopularMovie () async {
    Response serverResponse  = await get(Uri.parse('$_baseUrl$_popularEndPoint?language=en&api_key=$_apiKey'));
  ...
  static Future<PopularResponse> getNewRealeasesMovie () async {
    Response serverResponse  = await get(Uri.parse('$_baseUrl$_newRealeasesEndPoint?language=en&api_key=$_apiKey'));
    if (serverResponse.statusCode >= 200 && serverResponse.statusCode < 300) {
      Map json = jsonDecode(serverResponse.body) as Map;
      PopularResponse popularResponse = PopularResponse.fromJson(json);
      print(popularResponse.results);
  ...
  static Future<PopularResponse> getRecommendedMovie () async {
    Response serverResponse  = await get(Uri.parse('$_baseUrl$_recommendedEndPoint?language=en&api_key=$_apiKey'));
    if (serverResponse.statusCode >= 200 && serverResponse.statusCode < 300) {
      Map json = jsonDecode(serverResponse.body) as Map;
      PopularResponse popularResponse = PopularResponse.fromJson(json);
      print(popularResponse.results);
  ...
  static Future<DetailsMovie> getDetailsMovie (String movieId) async {
    Response serverResponse  = await get(Uri.parse('$_baseUrl/movie/$movieId?language=en&api_key=$_apiKey'));
    if (serverResponse.statusCode >= 200 && serverResponse.statusCode < 300) {
      Map json = jsonDecode(serverResponse.body) as Map;
  ...
  static Future<PopularResponse> getSimilarMovie (String movieId) async {
    Response serverResponse  = await get(Uri.parse('$_baseUrl/movie/$movieId/similar?language=en&api_key=$_apiKey'));
    if (serverResponse.statusCode >= 200 && serverResponse.statusCode < 300) {
      Map json = jsonDecode(serverResponse.body) as Map;
      PopularResponse popularResponse = PopularResponse.fromJson(json);
      print(popularResponse.results);
  ...
  static Future<PopularResponse> searchMovie (String movie) async {
    Response serverResponse  = await get(Uri.parse('$_baseUrl/search/movie?query=$movie&language=en&api_key=$_apiKey'));
    if (serverResponse.statusCode >= 200 && serverResponse.statusCode < 300) {
      Map json = jsonDecode(serverResponse.body) as Map;
      PopularResponse popularResponse = PopularResponse.fromJson(json);
      print(popularResponse.results);
